...
<head>
    <meta charset="UTF-8">
    <title>Bienvenido a Authentic Learn</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">¡Bienvenido a Authentic Learn!</div>
        ...
        <p><strong>Estaremos en contacto contigo muy pronto</strong> para proporcionarte el enlace de acceso a la plataforma y toda la información necesaria para comenzar tu experiencia de aprendizaje.</p>
        
        <p>Mientras tanto, si tienes alguna pregunta o necesitas soporte, no dudes en contactarnos. Estamos aquí para acompañarte en tu crecimiento profesional.</p>
        <div class="footer">
            Gracias por confiar en Authentic Learn.<br>
